      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex h-16 items-center justify-between ">
          ...
          <Image
            ...
            width={50}
            height={50}
            className="w-12 h-12 rounded-full overflow-hidden border-2 border-yellow-500 flex-shrink-0"
          />
          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className={`relative px-3 py-2 text-sm font-medium rounded-lg transition-colors ${activeSection === link.href
            ...
            <div className="px-4 py-3 space-y-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className={`block px-3 py-2 text-sm font-medium rounded-lg transition-colors ${activeSection === link.href
                      ? "text-accent bg-accent-glow"
                      : "text-muted hover:text-accent hover:bg-accent-glow"
                    }`}
                >
