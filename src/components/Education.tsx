          ...
          {education.map((edu, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Content card */}
                <div className="group w-full gradient-border-card glow-hover bg-card border border-card-border rounded-xl p-5 sm:p-6 hover:border-accent/30 transition-all relative">
