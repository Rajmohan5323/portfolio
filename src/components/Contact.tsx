    ...
    <section id="contact" className="section-padding" ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          >
            <div className="gradient-border-card glow-hover bg-card border border-card-border rounded-2xl p-6 space-y-5">
          ...
          >
            <form
              ...
              className="gradient-border-card glow-hover bg-card border border-card-border rounded-2xl p-6 sm:p-8 space-y-5"
            >
